...
// We use a safe check to ensure environment variables exist
...
export default function FeedbackModal({ isOpen, onClose }: FeedbackModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        console.log("Data being sent:", { message, user_email: email, page_url: window.location.pathname });

        try {
            // 2. Insert Data into Supabase
            // We add .select() at the end to force Supabase to return the saved row (or error)
            ...
            <div className="bg-[#111] border border-white/10 p-6 rounded-2xl w-full max-w-md relative shadow-2xl">
                ...
                {!sent ? (
                    ...
                    <div className="text-center py-10">
                        <div className="w-16 h-16 bg-green-500/20 rounded-full flex items-center justify-center text-3xl mx-auto mb-4 animate-bounce">
                            ✅
                        </div>
