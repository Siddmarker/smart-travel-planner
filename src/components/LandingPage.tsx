        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              ...
              <li><button onClick={() => setShowFeedback(true)} className="hover:text-blue-400 text-left">Contact / Feedback</button></li>
          ...
          <div className="bg-[#111] border border-white/10 p-8 rounded-3xl w-full max-w-md relative shadow-2xl">
            ...
            {!sent ? (
              <form onSubmit={handleEmailLogin} className="space-y-3">
                <input type="email" placeholder="name@example.com" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none font-medium transition-all" value={email} onChange={(e) => setEmail(e.target.value)} required />
